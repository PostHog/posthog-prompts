...
export function Popup() {
  ...
  function initPopUp(payload, flag) {
    ...
    try {
      setLocationCSS(
        generateLocationCSS(payload.location, payload.locationCSSSelector)
      );
    } catch (e) {
      console.error(e);
      return;
  ...
  return (
    <div
      className="popup"
      style={{ display: showPopup ? "flex" : "none", ...locationCSS }}
    >
      ...
      <div className="bottom-section">
        <div
          className="buttons"
          style={{
            justifyContent: payload.primaryButtonText
              ? "space-between"
              : "center",
          }}
        >
          {payload?.secondaryButtonText && (
            <button
              ...
              onClick={() =>
                closePopUp(activeFlag, payload, setShowPopup, "secondary")
              }
            >
              {payload.secondaryButtonText}
            </button>
          ...
          {payload.primaryButtonText && (
            <button
              ...
              onClick={() =>
                closePopUp(activeFlag, payload, setShowPopup, "primary")
              }
            >
              {payload.primaryButtonText}
            </button>
